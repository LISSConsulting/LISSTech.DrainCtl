...
<div
    class="confirm-overlay {closing ? 'closing' : ''}"
    ...
    <div class="modal-wrap">
        ...
        <div class="confirm-modal">
            ...
            <div class="confirm-actions">
                ...
                {#if saveLabel && onsave}
                    <button class="btn-brutal confirm-save" onclick={() => animateClose(onsave)}>{saveLabel}</button>
                {/if}
...
<style>
    ...
    .confirm-overlay.closing > .modal-wrap {
