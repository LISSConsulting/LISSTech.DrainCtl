...
| `message` | string | `"Event count 47 in 60s window; expected ~3.2 at this time-of-day; tail probability 2.1e-7."` | Human-readable single sentence. |
...
| `window_end` | RFC 3339 | `"2026-04-16T14:23:42-05:00"` | End. Always `window_start + 60s`. |
...
| `first_seen_at` | RFC 3339 | `"2026-04-16T14:20:42-05:00"` | When the spike first breached threshold (may be 60s or 120s before `window_start`). |
...
```json
{
  ...
  "status": "alert",
  "message": "Event count 47 in 60s window; expected ~3.2 at this time-of-day; tail probability 2.1e-7.",
  "version": "26.106.12",
  "spike": {
