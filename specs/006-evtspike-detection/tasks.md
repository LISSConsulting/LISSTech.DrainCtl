...
- [x] T092 (DROPPED — was standalone CLI Path B validation; standalone scope-reduced on 2026-04-17)
...
- [x] T096 (Superseded by T094d — kept as an optional manual sanity check on real hardware; not a gate.)
