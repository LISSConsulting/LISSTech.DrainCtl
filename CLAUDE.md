...
- Version is CalVer `YY.DOY.patch` — update in **10 places**: `drainctl.go`, `drainctl.rc`, `.psd1`, `.wixproj`, `.wxs`, `Bundle/*.wxs`, `Bundle/*.wixproj`, `README.md`, `CLAUDE.md`, `docs/index.html`
